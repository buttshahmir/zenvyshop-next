        ...
        {showFilters && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => { setMinPrice(''); setMaxPrice(''); }} className="text-sm text-gold hover:text-gold-dark">
                Reset
              </button>
            </div>
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <input
                ...
                className="w-32 px-3 py-2 border border-gray-200 rounded-lg"
              />
              <button onClick={fetchProducts} className="bg-gold text-black px-4 py-2 rounded-lg text-sm font-medium hover:bg-gold-light transition-colors">
                Apply
              </button>
            </div>
          </motion.div>
        ...
        {!error && (
          loading ? (
            ...
            <div className="text-center py-20">
              ...
              <button onClick={clearFilters} className="mt-4 text-gold hover:text-gold-dark font-medium">
                Clear all filters
              </button>
            </div>
          )
